...
{/* aqui seria informações sobre as mídias sociais, não sei se será necessário. */}
      ...
      <footer className="w-full bg-blue-400 text-start">
        <div className="w-full mx-auto p-5 flex flex-wrap box-border">
          {/* <!-- Coluna 1 --> */}
          {/* <div className="w-full md:w-1/4 p-5 box-border flex flex-col text-gray-800">
          
          </div> */}
          {/* <!-- Coluna 2 --> */}
          <div className="w-full md:w-2/3 p-5 box-border flex flex-col text-gray-800">
            {/* <h1 className="text-2xl font-bold mb-0">Pulsares</h1> */}
            <div className="flex flex-col">
              <img src={logoPulsares} alt="logo" className="h-25 w-25 align-center"></img>
            </div>
            <div className="flex flex-col h-full">
              <div className="flex gap-1 mb-2">
              <a href="https://www.instagram.com/pulsar.es/"><Instagram className="h-4 w-4 hover:text-orange-500"/></a>
              <a href="https://www.linkedin.com/company/pulsares-engenharia"><Linkedin className="h-4 w-4 hover:text-orange-500"/></a>
            </div>
            <ul className="space-y-1 text-sm">
              ...
              <li className="flex">
                <i className="mr-1"><Phone className="h-4 w-4 opacity-60" /></i>
                <p>+55 (85) 99966-6948 - Gil Palácio (CEO)</p>
                <p>+358 046 5456808 - Mário Alves (COO)</p>
              </li>
              <li className="flex">
                <i className="mr-1"><MailPlus className="h-4 w-4 opacity-60" /></i>spinoffvibracao@gmail.com
              </li>
            </ul>
            </div>
          </div>
          ...
          {/* <!-- Coluna 2 --> */}
          <div className="w-full md:w-1/3 p-5 box-border flex flex-col text-gray-800 align-end">
